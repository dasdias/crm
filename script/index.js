...
const createRow = ({ id, title, price, description, category, discont, count, units, images: { small, big } }) => {
  ...
  const secondTD = createTD('td', ['table__cell', 'table__cell_left', 'table__cell_name'], title, id);
  ...
  wrapBtn.insertAdjacentElement('afterbegin', createTD('button', ['table__btn', 'table__btn_del']));
  wrapBtn.insertAdjacentElement('afterbegin', createTD('button', ['table__btn', 'table__btn_edit']));
